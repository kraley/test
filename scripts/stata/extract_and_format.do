...
log using "$logs/extract_and_format.log", replace

forvalues wave=1/4 {
        clear
	set maxvar 5500
	use "$original/pu2014w`wave'_compressed"
...
forvalues wave=1/4 {
        clear
	set maxvar 5500
	use "$oridinal/pu2014w`wave'_compressed"
	...
	save "$interim/wave`wave'_type2_extract", replace
}
